...
public class AliyunBailianController {
     ...
     */
    @GetMapping("/generate")
    public String generate(@RequestParam(value = "message",defaultValue = "Who are you?") String message,
    ...
    public Flux<AIResponse> generateStream(@RequestParam(value = "message", defaultValue = "你是谁？") String message) {
        //系统角色消息
        SystemMessage systemMessage=new SystemMessage("请你一名专业的Java开发工程师");
        //用户角色消息
